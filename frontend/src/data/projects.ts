...
export const projects: Project[] = [
  {
    ...
    description: 'A modern, SEO-optimized restaurant website built using Wix Studio, featuring an interactive menu, reservation system, and e-commerce integration.',
  ...
  },
  {
    ...
    description: 'An educational 2D game built in GameMaker Language that simulates cocktail creation.',
  ...
  },
  {
    ...
    description: 'A full-stack web application for personalized event and checklist management.',
    longDescription: 'This application allows users to create accounts, log in, and securely manage weekly events and checklists. Events can be created, edited, deleted, and pinned. User authentication and data persistence are handled through a secured backend.',
    image: weekly_todo,
    category: 'web',
  ...
  },
  {
    ...
    description: 'Demo website using React to visually showcase proposed website design and functionality.',
  ...
  },
  {
    ...
    description: 'A browser-based Classic Connect Four game featuring player vs AI mode.',
    longDescription: 'This project is a web-based implementation of the classic Connect Four game, developed using HTML, CSS, and JavaScript. It features a challenging AI opponent powered by the minimax algorithm with alpha-beta pruning, ensuring efficient and optimal decision-making.',
    image: 'https://www.sciencebuddies.org/51bmjfuB2tMQUMzB1_Pafdt13-k=/750x419/-/https/www.sciencebuddies.org/cdn/Files/20146/8/connect-4-game-tree-diagram.png',
    category: 'web',
